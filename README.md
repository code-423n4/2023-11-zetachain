...
- Submit findings [using the C4 form](https://code4rena.com/contests/2023-10-zetachain/submit)
- [Read our guidelines for more details](https://docs.code4rena.com/roles/wardens)
- Starts November 20, 2023 20:00 UTC (ex. `Starts March 22, 2023 20:00 UTC`)
- Ends December 18,2023 20:00 UTC (ex. `Ends March 30, 2023 20:00 UTC`)
